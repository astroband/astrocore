...
struct AssetAlphaNum4 // compability struct
{
    opaque assetCode[4]; // 1 to 4 characters
    AccountID issuer;
};

struct AssetAlphaNum12 // compability struct
{
...
//        AccountID issuer;
//    } alphaNum4;
case ASSET_TYPE_CREDIT_ALPHANUM4: // compability struct
    AssetAlphaNum4 V1;
...
//        AccountID issuer;
//    } alphaNum12;
case ASSET_TYPE_CREDIT_ALPHANUM12: // compability struct
    AssetAlphaNum12 V2;
...
union LedgerEntryData switch (LedgerEntryType type) // compability struct
{
case ACCOUNT:
