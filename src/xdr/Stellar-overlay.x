...
struct AuthenticatedMessageV0 // compability struct
{
   uint64 sequence;
...
enum AuthenticatedMessageType { // compability enum
    V0 = 0
};

union AuthenticatedMessage switch (AuthenticatedMessageType type)
{
case V0:
